...
/**
 * \file    test/functional/WBSFunctionalTest.php
 * \ingroup wbs
 ...
 * @package Testwbs
 */
class WBSFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/wbs/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('wbs/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/wbs/admin/about.php');
		$this->authenticate();
		return $this->assertContains('wbs/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('wbswidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modWBS_WBSTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWBS_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
