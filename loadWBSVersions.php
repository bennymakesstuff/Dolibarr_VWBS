...
if(isset($_POST['wbs_parent'])){
  ...
  //This query just selects WBS Versions from the database
  $sql = "SELECT * FROM doli_wbs_wbs_versions ORDER BY rowid ASC";
    ...
    //$object->payload = [$num];
      ...
      if($num != 0){
        ...
        while($i < $num){
    		    ...
    		    $object->payload[$i] = $db->fetch_object($vwbsVersions);
        ...
        $object->payload = "No Rows";
  		...
  		$vwbsVersions = "FAILURE: SQL Returned ".$num." results";
  	}
    $vwbsVersions = "FAILURE: SQL Request Success";
  }
  else{
  	$vwbsVersions = "FAILURE: SQL Request Failed";
  }
