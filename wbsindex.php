...
/**
 *	\file       wbs/wbsindex.php
 *	\ingroup    wbs
 *	\brief      Home page of wbs top menu
 */
...
$langs->loadLangs(array("wbs@wbs"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->wbs->read) accessforbidden();
...
llxHeader("", $langs->trans("WBSArea"));

print load_fiche_titre($langs->trans("WBSArea"), '', 'wbs.png@wbs');
...
// Draft MyObject
if (! empty($conf->wbs->enabled) && $user->rights->wbs->read)
{
	$langs->load("orders");
